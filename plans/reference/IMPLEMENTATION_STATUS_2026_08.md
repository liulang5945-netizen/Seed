...
| E6-1 | [Native evolution and client embodiment route](../active/roadmap/63_TAIJI_NATIVE_EVOLUTION_AND_EMBODIMENT_20260831.md) | 当前阶段：把 `McpCapabilityInheritanceCandidate` 投影到 Seed-owned API/registry 的 shadow 状态，绑定 Workbench/MCP snapshot、生命周期和 rollback；暂不连接真实第三方 MCP、不激活客户端器官 |
