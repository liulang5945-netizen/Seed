...
- P3-3 已证明现有 provider watchdog、rotation、fallback、checkpoint/restart rebinding 的确定性 packaged-client 集成 seam；P6-1c 预检进一步确认本机缺少真实 checkpoint、tokenizer、safetensors 和 adapter 资产，因此真实模型质量与加载链保持 `asset-unverified`。
