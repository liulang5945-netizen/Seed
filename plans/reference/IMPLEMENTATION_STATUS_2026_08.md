...
| E5-3 | [Native evolution and client embodiment route](../active/roadmap/63_TAIJI_NATIVE_EVOLUTION_AND_EMBODIMENT_20260831.md) | 当前阶段：在真实 Vue slot 中验证 Seed-owned 本地只读 extension 的声明式挂载、卸载、失败回收和 snapshot rollback；完成后才进入真实第三方 MCP/plugin |
