...
> 最新状态覆盖：P7-1 真实 Qwen 语义质量 Gate 已完成测量但未通过；Qwen2.5-0.5B-Instruct 仅保留为实验/回退 provider。E1–E4、E5-0～E5-3、E6-0～E6-4 均已完成对应 Gate，主线已完成 MCP client capability candidate、shadow registry、activation proposal、prepare-only dry-run 和显式连接授权边界；当前停在 E6-5 真实第三方 MCP 目标与权限确认。
