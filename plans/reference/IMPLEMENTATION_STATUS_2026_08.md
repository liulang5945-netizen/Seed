...
| E3-4 | [Native evolution and client embodiment route](../active/roadmap/63_TAIJI_NATIVE_EVOLUTION_AND_EMBODIMENT_20260831.md) | 当前阶段：固定容量对照、持续误差/容量压力与结构候选触发前置 Gate；只有独立 fixed-capacity 失败证据才允许 proposal，先不直接扩容、不接 provider |
