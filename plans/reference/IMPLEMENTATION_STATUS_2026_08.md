...
| E4 | [Native evolution and client embodiment route](../active/roadmap/63_TAIJI_NATIVE_EVOLUTION_AND_EMBODIMENT_20260831.md) | 当前阶段：将受治理 Skill/MCP artifact 知识分别内化为 Taiji-owned semantic/procedural/affordance artifact；客户端 capability 继承仍保持独立候选和独立准入 |
