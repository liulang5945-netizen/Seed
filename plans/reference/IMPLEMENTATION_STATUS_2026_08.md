...
| E5 | [Native evolution and client embodiment route](../active/roadmap/63_TAIJI_NATIVE_EVOLUTION_AND_EMBODIMENT_20260831.md) | 当前阶段：建立 Seed-owned extension host 与 client capability snapshot 两阶段生命周期；先实现隔离、依赖健康、状态迁移、递归 disposer、故障 quarantine 和 rollback，再接真实第三方 MCP/plugin |
