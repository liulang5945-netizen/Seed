...
| E6-0 | [Native evolution and client embodiment route](../active/roadmap/63_TAIJI_NATIVE_EVOLUTION_AND_EMBODIMENT_20260831.md) | 当前阶段：把已治理 MCP 知识与运行时能力拆成 Taiji cognitive artifact 和 Seed-owned client capability inheritance candidate，先建立 schema、权限、凭据、资源和 shadow 边界；暂不连接真实第三方 MCP |
