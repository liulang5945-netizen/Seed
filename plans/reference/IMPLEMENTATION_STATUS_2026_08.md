...
| E5-1 | [Native evolution and client embodiment route](../active/roadmap/63_TAIJI_NATIVE_EVOLUTION_AND_EMBODIMENT_20260831.md) | 当前阶段：把 E5-0 host 接入 API/Vue/Workbench 的 client snapshot 两阶段发布与 capability registry；完成 route/sidebar/panel/command/settings/visualization slots、旧 Legacy MCP 迁移边界和产品级生命周期观测后，才进入真实第三方 MCP/plugin |
