...
状态已滚动更新：四步连续重规划与 3/4/5 步变量 episode、不同失败位置和 after-state relation 变化已通过 3-seed Gate；当前唯一下一步是把变量 horizon 接入真实 world-dynamics prediction/error calibration。
