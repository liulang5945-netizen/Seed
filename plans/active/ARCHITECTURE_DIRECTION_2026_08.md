...
状态已滚动更新：四步连续重规划、3/4/5 步变量 episode、不同失败位置、after-state relation 变化、executive-to-world prediction train/holdout 与 no-online-update calibration control，以及 runtime calibration trace contract 均已通过；当前唯一下一步是把 trace 纳入 3-seed 多步 Gate，验证连续性和 checkpoint 恢复。
