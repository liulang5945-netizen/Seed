...
执行顺序只看 [SEED_DEVELOPMENT_ROADMAP_2026_08.md](SEED_DEVELOPMENT_ROADMAP_2026_08.md)。P1 已完成首个兼容纵切片，P2 relation subgate 已在两个独立语料分区通过；当前唯一入口是 P3 world-state/action-outcome 最小纵切片，避免把结构性 relation 通过误认为完整能力。
