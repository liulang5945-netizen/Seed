...
**当前唯一下一步：把 perception-to-world 闭环扩展为变量时长、三段以上 assembly 与两步以上 world transition 的跨 episode Gate，加入关系变化、真实 outcome feedback/world learner online calibration、workspace lesion、lineage 和 checkpoint continuation；仍需保留 unseen object/relation holdout 与 relation subgate，CUDA 保持暂缓。**
