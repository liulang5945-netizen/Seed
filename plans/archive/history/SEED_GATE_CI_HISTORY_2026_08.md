# 归档：持续门禁、CI 事故与 Gate 证据（截至 2026-08-29）

> 本文件是历史证据，不提供当前执行顺序。仍生效的规则已提炼到 [当前门禁与 CI](../../active/roadmap/02_GATES_AND_CI.md)，当前下一步只看 [当前执行状态](../../active/roadmap/03_CURRENT_EXECUTION.md)。下文的“下一入口”均保留其当时语境，不得恢复为当前路线。
