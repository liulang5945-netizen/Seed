...
> 更新：2026-09-18。用户澄清要补的是像多模态、恶意信息一样遗漏的完整方向：本轮唯一VISION §23新增能力/风险版图及八项实际方案，根需求/架构/01/07同步入口。§20多模态、§21恶意信息继续保留，§22归位为运行机制细化，不再充当大方向查漏的回答。推荐设计不等于架构采用或新运行授权，局部实验仍按02 §2.5有条件准入；最新研究状态与唯一下一步只看03及有效合同/裁决。
...
| 像多模态、恶意信息一样，还有哪些大方向被忽略？ | [VISION §23](reference/VISION_FUTURE_TECHNOLOGY.md#23-能力与风险版图补全被局部主线遮蔽的八个大方向)、[01 §4.1](active/roadmap/01_SCOPE_AND_PHASES.md#41-能力与风险版图补漏2026-09-18用户澄清) | 常识、抽象推理、空间物理、社会认知、目标对齐、正常数据风险、创造/生成、多语言；区分未展开与已有原则，给方案及归属 |
