"""Build the SCALED R2-H3.8 joint-sequence corpus (candidate 3: course/data) (data contract step).
...
FIXTURE = Path("tests/fixtures/r2_h3_8_joint_sequence_scaled_v1.jsonl")
REPORT = Path("reports/r2_h3_8_data_contract_scaled_20260917.json")
FORMAT = "taiji-r2-h3-8-joint-sequence-corpus-scaled-v1"
GENERATION_SEED = 20260917

ENTITY_POOLS = {
    "train": {
        "objects": ("天空", "草", "树叶", "海洋", "山川", "城市", "森林", "河流"),
        "colors": ("蓝", "绿", "红", "黄"),
    },
    "dev": {"objects": ("雪", "太阳", "沙漠", "湖水"), "colors": ("白", "灰", "银", "粉")},
    "final": {"objects": ("夜晚", "大海", "火焰", "冰川"), "colors": ("黑", "橙", "紫", "棕")},
}
