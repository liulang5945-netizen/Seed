        ...
        with patch(
            ...
            with (
                ...
                execute = client.post(
                    ...
                    json={
                        "plan_id": plan_id,
                        "approval_tokens": {request_id: approval_payload["approval_token"]},
                    },
                )
                ...
                plan_schema = schema["paths"]["/api/chat/workbench/natural-language/plan"]["post"][
                    "requestBody"
...
def main() -> None:
    ...
    report_path = (
        PROJECT_ROOT / "reports" / "taiji_w7_p2_13_natural_language_workbench_api_20260831.json"
    )
    report = evaluate()
