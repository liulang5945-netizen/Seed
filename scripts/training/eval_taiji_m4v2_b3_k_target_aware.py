"""Run the target-aware K course diversity diagnostic."""
...
def run_target_aware(
    *,
    ...
    report = run_stability(
        ...
        require_target_diversity=True,
    )
    report["report_format"] = REPORT_FORMAT
    report["version"] = VERSION
    report["run_kind"] = "target-aware-course-diversity-diagnostic"
    return report
