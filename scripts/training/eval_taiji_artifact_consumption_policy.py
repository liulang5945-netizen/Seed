...
def evaluate() -> dict[str, object]:
    ...
    try:
        ...
        strict_restored = SeedRuntime.load(strict_checkpoint, workspace_root=PROJECT_ROOT)
        ...
        legacy_restored = SeedRuntime.load(legacy_checkpoint, workspace_root=PROJECT_ROOT)
