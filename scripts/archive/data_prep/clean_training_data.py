...
def clean_alpaca_zh():
    ...
    with open(input_path, "r", encoding="utf-8") as f:
        for line in f:
            ...
            try:
                ...
                msgs[0][
                    "content"
                ] = "你是态极（Taiji），一个由Taiji Developer创造的本地AI生命体。你运行在用户的电脑上，数据不出本机。你会用自然、友好的方式回答用户的问题。"
    ...
    print(
        f"alpaca_zh: {len(cleaned)} kept, {removed_short} short removed, {removed_dup} dup removed"
    )
                ...
                try:
                    ...
                    if msgs and msgs[0]["role"] == "system":
                        ...
                        if "态极" in old_sys and "有帮助" in old_sys:
                            msgs[0][
                                "content"
                            ] = "你是态极（Taiji），一个由Taiji Developer创造的本地AI生命体。你运行在用户的电脑上，数据不出本机。"
