...
The public package family belongs to the `@taiji` scope and uses the `node-addon-system` package prefix; platform packages append platform information only:

```text
@taiji/node-addon-system
@taiji/node-addon-system-<platform>
```
