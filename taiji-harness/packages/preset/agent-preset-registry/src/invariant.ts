/**
 * Package-owned invariant companion for `@taiji/dsh-agent-preset-registry`.
 * @module @taiji/dsh-agent-preset-registry/invariant
 */
...
import { leakedServices, livePresetMounts } from '@taiji/dsh-agent-preset-registry'

const PACKAGE_NAME = '@taiji/dsh-agent-preset-registry'
