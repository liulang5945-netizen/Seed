...
import type { AuthorizationMethod, AuthorizationPrompt, AuthorizationSession } from '@taiji/dsh-authorization'
import { isCredentialKeySegment } from '@taiji/dsh-credentials'
