...
import type { AuthorizationInteraction, AuthorizationNotice, AuthorizationPrompt } from '@taiji/dsh-authorization'
import LocalCredentialProvider from '@taiji/dsh-credentials-local'
import type { CredentialKey } from '@taiji/dsh-credentials'
