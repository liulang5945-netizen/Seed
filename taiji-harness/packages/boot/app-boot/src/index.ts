...
import { Context, type FiberState } from '@taiji/cordis'
import Loader, { type Entry, type EntryOptions } from '@taiji/cordis-plugin-loader'
...
import { dshHomePath, resolveDshHome } from '@taiji/dsh-home-paths'
import { createLaunchEnvironmentSnapshot, type LaunchEnvironmentSnapshot } from '@taiji/dsh-launch-environment'
 ...
 * entries (`@taiji/cordis-plugin-include`'s `PatchOptions`): id-targeted config
 ...
 * `@taiji/cordis-plugin-include` `PatchOptions` (id-targeted config overrides and
...
export async function mountRootInclude(
  ...
  // preset living outside this workspace cannot resolve `@taiji/cordis-plugin-group`
