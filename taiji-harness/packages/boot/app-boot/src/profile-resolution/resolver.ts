...
import type { ModuleLoaderV1, ModuleLoaderV2, ResolveResult } from '@taiji/cordis-plugin-loader'
...
const WORKER_RESOLUTION_KEY = '@taiji/dsh-app-boot/profile-resolution'
