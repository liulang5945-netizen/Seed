...
import type { ProcessInspectorInternals } from '@taiji/dsh-subprocess-local/src/process-inspector.ts'
import { WindowsProcessInspector } from '@taiji/dsh-subprocess-local/src/windows-inspector.ts'
