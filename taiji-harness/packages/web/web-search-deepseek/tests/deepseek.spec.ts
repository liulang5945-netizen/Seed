...
import WebRuntime, { WebError } from '@taiji/dsh-web'
import {
  DeepSeekSearchProvider,
  DEEPSEEK_PROVIDER_ID,
} from '@taiji/dsh-web-search-deepseek'
...
import type { AnthropicResponse } from '@taiji/dsh-web-search-deepseek/src/types.ts'

/** Construct the provider over a fixed options value; production passes a live thunk. */
import type { DeepSeekSearchProviderOptions } from '@taiji/dsh-web-search-deepseek'
