...
import type { GenericCallView, ToolResult, WebFetchResultView } from '@taiji/dsh-tools'
import type { WebFetchBody, WebFetchResult } from '@taiji/dsh-web'
 ...
 * `@taiji/dsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@taiji/dsh-tool-call-timeout-policy` to enforce.
