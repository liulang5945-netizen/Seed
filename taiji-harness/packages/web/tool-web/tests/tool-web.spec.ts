...
import type { WebSearchProvider, WebSearchResult } from '@taiji/dsh-web'
...
} from '@taiji/dsh-tool-web'
import type { ContentBlock } from '@taiji/dsh-llm'
import type { ToolResult } from '@taiji/dsh-tools'
...
async function mountTools(opts: {
  ...
  fetchProvider?: import('@taiji/dsh-web').WebFetchProvider
