 ...
 *
 * @module @taiji/dsh-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@taiji/schemastery'
import type { Context } from '@taiji/cordis'
import type {} from '@taiji/dsh-command-feedback'
import type {} from '@taiji/dsh-message-feedback'
import { Session, type SessionEvent } from '@taiji/dsh-session'
import {
...
} from '@taiji/dsh-session-telemetry'
import { APP_IDENTITY } from '@taiji/dsh-llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@taiji/dsh-session-telemetry-otel', version)
