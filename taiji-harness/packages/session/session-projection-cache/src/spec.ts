 ...
 * @module @taiji/dsh-session-projection-cache/src/spec
 */

import { z } from 'zod'
import { isJsonValue } from '@taiji/dsh-util-values'
import type { JsonValue } from '@taiji/dsh-util-values'
import { SessionLogOffset, SessionSeq } from '@taiji/dsh-session'
import type { SessionId, SessionSeqCursor } from '@taiji/dsh-session'
import { defineDomain, domainTable } from '@taiji/dsh-storage-domain'
