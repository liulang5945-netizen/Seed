 ...
 * @module @taiji/dsh-session-persistence
 */

import { Context, Service } from '@taiji/cordis'
import type { SessionEvent, SessionHeader, SessionId, SessionLogOffset } from '@taiji/dsh-session'
import type { SessionHandle, SessionAccess } from './handle.ts'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@taiji/dsh-session'
