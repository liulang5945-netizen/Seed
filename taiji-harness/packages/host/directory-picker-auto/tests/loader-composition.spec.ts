...
import HttpServer from '@taiji/dsh-host-webserver'
import type { DirectoryPicker } from '@taiji/dsh-host-directory-picker'
import BrowseDirectoryPicker from '@taiji/dsh-host-directory-picker-browse'
import NativeDirectoryPicker from '@taiji/dsh-host-directory-picker-native'
import {
...
const AUTO = '@taiji/dsh-host-directory-picker-auto'
const NATIVE = '@taiji/dsh-host-directory-picker-native'
const BROWSE = '@taiji/dsh-host-directory-picker-browse'
const NATIVE_SURFACE = '@taiji/dsh-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@taiji/dsh-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  const modules = new Map<string, unknown>([
    ['@taiji/dsh-host-webserver', HttpServer],
