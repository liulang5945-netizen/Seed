...
import * as Connection from '@taiji/dsh-client-connection'
...
async function loadComposition(): Promise<Context> {
  ...
  await writeFile(configPath, [
    ...
    "    host: '127.0.0.1'",
    '    port: 0',
    "- name: '@taiji/dsh-client-connection'",
    '- id: frontend',
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@taiji/dsh-client-connection', Connection],
    ['@taiji/dsh-host-frontend-static', FrontendStatic],
  ])
