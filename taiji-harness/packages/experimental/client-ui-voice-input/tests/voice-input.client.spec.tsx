...
import { bindSnapshotSelector, makeTranslate, RemoteError } from '@taiji/dsh-client-test-runtime'
...
import type { SpeechProviderId, Transcript } from '@taiji/dsh-experimental-speech-to-text/types'
