...
import { spawn, spawnSync } from '@taiji/dsh-experimental-webworker-runtime/src/node/builtin_modules/implemented/child_process.ts'
import {
  LAUNCHER_FAILURE_EXIT, grantArgs, launcherPath, probe,
} from '@taiji/node-addon-system/landlock-run'
import { processAlive, signalProcess } from '@taiji/dsh-experimental-webworker-runtime/src/node/process-table.ts'
import { hostFileSystem } from '@taiji/dsh-experimental-webworker-runtime/src/shell/fs-access.ts'
import {
  LANDLOCK_EXECUTABLE, landlockFileSystem, parseLandlockArguments,
} from '@taiji/dsh-experimental-webworker-runtime/src/shell/process/landlock.ts'
import { spawnSubprocess } from '@taiji/dsh-subprocess-local/src/spawn.ts'

vi.mock('node:child_process', async () =>
  await import('@taiji/dsh-experimental-webworker-runtime/src/node/builtin_modules/implemented/child_process.ts'))
