...
import { runShellCommand } from '@taiji/dsh-experimental-webworker-runtime/src/shell/interpret.ts'
import { filesystemError } from '@taiji/dsh-experimental-webworker-runtime/src/shell/fs-access.ts'
import type {
  ShellDirent, ShellFileSystem, ShellRunOutcome, ShellStats,
} from '@taiji/dsh-experimental-webworker-runtime/src/shell/types.ts'
