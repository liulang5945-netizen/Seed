...
import type { CommandDescriptor } from '@taiji/dsh-commands/types'
import type { TranslateNS } from '@taiji/dsh-client-locale/client'
import { en, zh } from './locales.ts'

const BUILTINS = {
  goal: '@taiji/dsh-command-goal',
  plan: '@taiji/dsh-plan-mode',
  feedback: '@taiji/dsh-command-feedback',
  compact: '@taiji/dsh-command-compact',
  permission: '@taiji/dsh-permission-presets',
  export: '@taiji/dsh-session-log-export',
} as const
