...
import type { TerminalBlockLabels, TerminalBlockProps } from '@taiji/dsh-client-ui-primitives'
...
/**
 * Parse the marker literals owned by `@taiji/dsh-shell/render` without
