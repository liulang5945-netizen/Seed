...
export const zh = {
  ...
  installSpecPlaceholder: '例如 @taiji/dsh-experimental-auto-review',
  installGuideToggle: '插件安装引导和示例',
  installGuideHide: '收起引导',
  installGuideIdTitle: '包名',
  installGuideIdExample: '@taiji/dsh-experimental-auto-review',
  ...
  installGuideSafety: '请确认插件来源可信。插件在本机以你的权限运行，来源不明的插件可能损坏 Taiji Harness，或读取和泄露你的数据。',
  registryToggle: '安装源',
...
export const en = {
  ...
  installSpecPlaceholder: 'for example @taiji/dsh-experimental-auto-review',
  ...
  installGuideSafety: 'Install only plugins you trust: they run with your permissions and can damage Taiji Harness or leak your data.',
