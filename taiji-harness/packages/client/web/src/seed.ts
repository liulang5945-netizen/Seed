...
import * as ClientStore from '@taiji/dsh-client-store'
import * as UiSlots from '@taiji/dsh-client-ui-slots'
import * as UiPrimitives from '@taiji/dsh-client-ui-primitives'
import * as UiDockkit from '@taiji/dsh-client-ui-dockkit'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@taiji/cordis': Cordis,
    '@taiji/dsh-client-store': ClientStore,
    '@taiji/dsh-client-ui-slots': UiSlots,
    '@taiji/dsh-client-ui-primitives': UiPrimitives,
    '@taiji/dsh-client-ui-dockkit': UiDockkit,
