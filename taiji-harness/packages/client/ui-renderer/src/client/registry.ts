...
import { SlotCore, StaleAuthorizationError, standardHookPropName } from '@taiji/dsh-client-ui-slots'
import type {
...
export class SlotRegistry extends Service {
  ...
  private rebuildRootBinding(): void {
    ...
    const keyedHooks: Record<string, import('@taiji/dsh-client-ui-slots').KeyedStandardSource> = {}
