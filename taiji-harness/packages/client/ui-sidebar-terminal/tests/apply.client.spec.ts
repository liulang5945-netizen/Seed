...
import type { WebTerminalId, WebTerminalInfo } from '@taiji/dsh-api-terminal-controller/types'
import { SidebarRightTabRegistry } from '@taiji/dsh-client-ui-sidebar-right/src/client/tab-registry.ts'
import type { SidebarRightCloseHandler } from '@taiji/dsh-client-ui-sidebar-right/client'
import type { SidebarRightOpenTab } from '@taiji/dsh-client-ui-sidebar-right/client'
