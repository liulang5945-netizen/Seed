...
import { apply as resourcesApply, inject as resourcesInject } from '@taiji/dsh-client-resources/src/client/index.ts'
import { apply as sidebarApply, inject as sidebarInject } from '@taiji/dsh-client-ui-sidebar-right/src/client/index.ts'
