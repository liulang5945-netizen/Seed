...
export const zh = {
  ...
  'error.sessionInUse': '当前会话已被占用，可能是其他正在运行的 Taiji Harness 导致的（如其他 dsh web、桌面端），请退出其他正在运行的 Taiji Harness 后重试。',
  'action.reload': '重新加载',
...
export const en = {
  ...
  'error.sessionInUse': 'This session is already in use, possibly by another running Taiji Harness instance (such as dsh web or the desktop app). Quit other running Taiji Harness instances and try again.',
