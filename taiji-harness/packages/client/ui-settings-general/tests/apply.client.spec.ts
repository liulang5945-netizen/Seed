...
import type { SettingsNamespaceView } from '@taiji/dsh-settings/types'
...
import { LOCALE_SETTINGS_NAMESPACE, LocaleSettingsSchema } from '@taiji/dsh-client-locale/src/locale-settings.ts'
