...
import { FileTypeIcon, IconChevronRightOutlineRegular } from '@taiji/dsh-client-ui-primitives'
...
import type { HostObservable, InjectFace, PropsLocale, PropsRuntime, PropsStore } from '@taiji/dsh-client-ui-slots'
