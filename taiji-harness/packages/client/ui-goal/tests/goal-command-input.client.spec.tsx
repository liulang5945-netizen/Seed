...
import { commandDefinition } from '@taiji/dsh-client-ui-chat/src/client/conversation-nodes/command.ts'
import { chatViewDefinition } from '@taiji/dsh-client-ui-chat/src/client/conversation-nodes/chat-snapshot-builder.ts'
