...
import type { GoalActivation, GoalId, GoalProjection, GoalView } from '@taiji/dsh-goal/client'
import { LocaleRuntime } from '@taiji/dsh-client-locale/client'
import { makeTranslate, RemoteError, TestSessions } from '@taiji/dsh-client-test-runtime'
