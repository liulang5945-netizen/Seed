...
import type { RightbarOwnerProps } from '@taiji/dsh-client-ui-layout/client'
...
import type { PaneId, TabId, TabRecord } from '@taiji/dsh-client-ui-dockkit'
import type { SlotHookFactory } from '@taiji/dsh-client-ui-slots'
