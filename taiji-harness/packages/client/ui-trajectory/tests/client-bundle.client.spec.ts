 ...
 * not built (`pnpm --filter @taiji/dsh-client-ui-trajectory bundle`).
 */
...
import { UiConversation } from '@taiji/dsh-client-ui-conversation/client'
import { SlotRegistry } from '@taiji/dsh-client-ui-renderer/client'

const PLUGIN_ID = '@taiji/dsh-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@taiji/dsh-client-store', await import('@taiji/dsh-client-store')],
      ['@taiji/dsh-client-ui-conversation/client', await import('@taiji/dsh-client-ui-conversation/client')],
      ['@taiji/dsh-client-ui-primitives', await import('@taiji/dsh-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@taiji/dsh-client-locale/client')
