...
import type {} from '@taiji/dsh-client-modules/client'
...
import type {} from '@taiji/dsh-client-ui-agent-preset/client'
// Inline-safe shared fold: shipped ids map to dictionary keys in one home.
import { presetDisplayText } from '@taiji/dsh-agent-preset-registry/display'
