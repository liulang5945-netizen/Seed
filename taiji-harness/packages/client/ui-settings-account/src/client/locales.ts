...
export const en = {
  ...
  loading: 'Loading…', backToHarness: 'Back to Taiji Harness',
  ...
  settingsSignedOutTitle: 'You are not signed in to Taiji Harness',
  settingsSignedOutDescription: 'Sign in to Taiji Harness to get your dedicated API Key',
...
export const zh: Record<AccountKey, string> = {
  ...
  loading: '加载中…', backToHarness: '返回 Taiji Harness',
  ...
  failed: '操作未完成，请重试。',
  settingsSignedOutTitle: '当前未登录 Taiji Harness 账号',
  settingsSignedOutDescription: '登录 Taiji Harness 账号获取专属 API Key',
