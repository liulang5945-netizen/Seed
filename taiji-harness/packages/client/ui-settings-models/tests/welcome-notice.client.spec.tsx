...
import { SettingsSchemaService } from '@taiji/dsh-client-ui-settings/src/client/schema.ts'
import { SettingsDescribeMirror } from '@taiji/dsh-client-ui-settings/src/client/settings-mirror.ts'
import { ConfigFormController } from '@taiji/dsh-client-ui-settings/src/client/config-form.ts'
...
describe('WelcomeNotice', () => {
  it('uses the exact owner copy in both GUI locales', () => {
    expect(WELCOME_NOTICE_COPY.en).toEqual({
      ...
      body: "Taiji Harness 0.1 remains in testing for Harness developers. Many areas need further improvement, and we welcome feedback from the developer community. Taiji Harness's core plugins and foundational APIs will continue to evolve rapidly over the coming months.\n\nWe look forward to exploring the limits of intelligence with developers around the world, building on open-source, open, reusable, and composable infrastructure. We welcome Harness developers everywhere to join the Taiji Harness plugin ecosystem.",
