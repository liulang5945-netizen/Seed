...
import { LAUNCHER_FAILURE_EXIT } from '@taiji/node-addon-system/landlock-run'
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from '@taiji/dsh-sandbox'
import type { SandboxPolicy } from '@taiji/dsh-sandbox'
import {
  LocalSandboxProvider,
} from '@taiji/dsh-sandbox-local'
import type { Config } from '@taiji/dsh-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @taiji/dsh-sandbox-windows-acl/tests/provider-chain.spec.ts
