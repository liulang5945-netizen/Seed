 ...
 *
 * @module @taiji/dsh-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@taiji/node-addon-system/landlock-run'
 ...
 * (`@taiji/dsh-fs-sandbox`) can never drift apart.
