 ...
 * @module @taiji/dsh-client-test-runtime/src/assembly/test-client
 */
import { Context, type Plugin } from '@taiji/cordis'
import type { Entry } from '@taiji/cordis-plugin-loader'
import { tearDownEntryFiber } from '@taiji/dsh-client-modules/client'
import {
  installConnection,
  type ConnectionHandle,
} from '@taiji/dsh-client-connection/client'
import { bootClient } from '@taiji/dsh-client-web/src/boot-client.ts'
import { mountClient } from '@taiji/dsh-client-web/src/mount.ts'
...
const CONNECTION_PACKAGE = '@taiji/dsh-client-connection'
...
export class TestClient {
   ...
   * its readiness behavior. The `@taiji/dsh-api-remotes` row is
