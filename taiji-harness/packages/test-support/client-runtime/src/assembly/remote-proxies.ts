 ...
 * @module @taiji/dsh-client-test-runtime/src/assembly/remote-proxies
 */
import type { Context } from '@taiji/cordis'
import { cancelledFailure, carrierFailure } from '@taiji/dsh-api-gateway/client'
...
export const REMOTES_PACKAGE = '@taiji/dsh-api-remotes'
