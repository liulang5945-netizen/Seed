...
const test = createClientTest({ roster: webApp.closure(['@taiji/dsh-api-gateway']) })
...
const missingConnection = createClientTest({ roster: webApp.pick(['@taiji/dsh-typert-registry']) })
