...
import { parseBootManifest } from '@taiji/dsh-client-modules/client'
import type { WebBootGraph } from '@taiji/dsh-client-modules/client'
import * as uiRenderer from '@taiji/dsh-client-ui-renderer/client'
import * as typertRegistry from '@taiji/dsh-typert-registry/client'
...
const RENDERER = '@taiji/dsh-client-ui-renderer'
const TYPERT = '@taiji/dsh-typert-registry'
const BRAND = '@taiji/dsh-client-ui-brand-official'
const MISSING = '@taiji/dsh-client-does-not-exist'
...
describe('createInProcessModules', () => {
  it('serves import() and prefetch() from registered factories and never loads a bundle', async () => {
    ...
    await expect(system.import('@taiji/dsh-client-unknown', '', {})).rejects.toThrow('cannot resolve')
  })
