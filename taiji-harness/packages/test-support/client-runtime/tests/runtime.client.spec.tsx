...
import { createSnapshotStore, defineStore } from '@taiji/dsh-client-store'
import { createScope, type SessionReference } from '@taiji/dsh-api-session-controller/client'
import type { WorkspaceId } from '@taiji/dsh-api-workspace-controller/client'
