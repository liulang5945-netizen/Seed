import { createUserMessage, type GenerateOptions } from '@taiji/dsh-llm'
import { describe, expect, it } from 'vitest'
import { Context, symbols, type EffectMeta } from '@taiji/cordis'
...
import SubagentRuntime, { type SubagentStartRequest } from '@taiji/dsh-subagent'
import SessionProjectionRegistry from '@taiji/dsh-session-projection'
import { MockAdapter, maxTokensResponse, textResponse, toolCallResponse } from '../../../core/agent-loop/tests/mock-adapter.ts'
import * as spawn from '../src/index.ts'
import { STRUCTURED_OUTPUT_TOOL } from '@taiji/dsh-subagent-in-process-driver'
