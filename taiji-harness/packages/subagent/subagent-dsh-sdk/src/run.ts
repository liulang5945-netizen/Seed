 ...
 * runtime over stdio JSON-RPC through `@taiji/dsh-sdk-client` and owns
 ...
 *
 * @module @taiji/dsh-subagent-dsh-sdk/run
 */
...
import type { SessionEvent, SessionId, TurnEndReason } from '@taiji/dsh-session'
import type { SubagentResult, SubagentRun, SubagentStartRequest, SubagentStopReason } from '@taiji/dsh-subagent'
import { AssistantOutputFold, settleRunResult, subprocessRunHandle } from '@taiji/dsh-subagent'
