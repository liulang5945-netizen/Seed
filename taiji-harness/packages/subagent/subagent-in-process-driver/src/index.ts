 ...
 * one result.
 *
 * @module @taiji/dsh-subagent-in-process-driver
 */

import { randomUUID } from 'node:crypto'
import type { Context } from '@taiji/cordis'
import { brandString } from '@taiji/dsh-brand'
import { foldConsumedWork } from '@taiji/dsh-agent'
import type { Agent, AgentHandle } from '@taiji/dsh-agent'
import { SessionLogOffset } from '@taiji/dsh-session'
import type { SessionEvent, SessionId, SessionLogOffset as SessionLogOffsetType, TurnEndReason } from '@taiji/dsh-session'
import { createUserMessage, type ContentBlock } from '@taiji/dsh-llm'
import {
