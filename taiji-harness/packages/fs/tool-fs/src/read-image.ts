 ...
 * @module @taiji/dsh-tool-fs/src/read-image
 */

import { basename, extname } from 'node:path'
import type { Context } from '@taiji/cordis'
import { AttachmentError, AttachmentId } from '@taiji/dsh-attachment'
import type { AttachmentStore, ImageAttachmentRef, ImageMediaType } from '@taiji/dsh-attachment'
import type { ContentBlock } from '@taiji/dsh-llm'
import { defineTool } from '@taiji/dsh-tools'
import type { GenericCallView, ToolExecution } from '@taiji/dsh-tools'
