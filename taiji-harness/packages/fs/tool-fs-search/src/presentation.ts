 ...
 * model-facing render consumes ({@link module:@taiji/dsh-tool-fs-search/search-core}
 ...
 *
 * @module @taiji/dsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@taiji/dsh-tool-fs-search/grep} `formatGrepMatches`), so
