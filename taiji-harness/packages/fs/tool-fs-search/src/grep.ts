 ...
 *
 * @module @taiji/dsh-tool-fs-search/grep
 */

import type { Context } from '@taiji/cordis'
import { defineTool } from '@taiji/dsh-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@taiji/dsh-tools'
import type { RetainedItems } from '@taiji/dsh-output-retention'
import type { SpillRef } from '@taiji/dsh-spill'
