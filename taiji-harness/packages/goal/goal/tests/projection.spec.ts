...
import GoalService, { GoalId, applyGoalProjection, foldGoal, goalProjectionDefinition } from '@taiji/dsh-goal'
import type { GoalProjection, GoalProjectionState, GoalRef } from '@taiji/dsh-goal'
