...
import * as GoalSessionInvariant from '@taiji/dsh-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@taiji/dsh-goal-round-driver'
import InvariantRegistry, { InvariantError } from '@taiji/dsh-invariants'
import SessionStore, { SessionId, type Session } from '@taiji/dsh-session'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@taiji/dsh-goal-round-driver',
    }))
  })
