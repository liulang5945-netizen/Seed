/** Package-owned goal-round prompt invariants. @module @taiji/dsh-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@taiji/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@taiji/dsh-goal'
...
const PACKAGE_NAME = '@taiji/dsh-goal-round-driver'
