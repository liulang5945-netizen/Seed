...
describe('dsh-base bundle', () => {
  it('declares a parseable patch list through the dsh.bundle.patch manifest field', () => {
    ...
    expect(manifest.dependencies).not.toHaveProperty('@taiji/dsh-subagent-codex')
    expect(manifest.dependencies).not.toHaveProperty('@taiji/dsh-subagent-claude-code')
    expect(manifest.dependencies).toHaveProperty('@taiji/dsh-web-fetch-http')
  })
