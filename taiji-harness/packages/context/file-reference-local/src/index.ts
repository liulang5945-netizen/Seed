 ...
 *
 * @module @taiji/dsh-file-reference-local
 */
...
export { FILE_REFERENCE_PROMPT } from '@taiji/dsh-file-reference'
export { activeAtToken, formatFileMention } from '@taiji/dsh-file-reference/grammar'
