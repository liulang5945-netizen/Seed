...
import { credentialKey, credentialKeyScope, credentialRef, parseCredentialKey } from '@taiji/dsh-credentials'
import type { CredentialKey, CredentialRecord } from '@taiji/dsh-credentials'
