/**
 * Package-owned invariant companion for `@taiji/dsh-storage-domain`: every
 ...
 * @module @taiji/dsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@taiji/dsh-storage-domain'
