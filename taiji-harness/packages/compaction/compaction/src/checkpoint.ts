 ...
 *
 * The seam itself lives in `@taiji/dsh-compaction`, which re-exports these
 ...
 *
 * @module @taiji/dsh-compaction/checkpoint
 */

import type { MessageSource } from '@taiji/dsh-llm/message'
