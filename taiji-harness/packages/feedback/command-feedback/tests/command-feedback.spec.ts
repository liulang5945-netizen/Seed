...
import SessionStore, { foldSurface, Session, SessionId } from '@taiji/dsh-session'
import * as commandFeedback from '@taiji/dsh-command-feedback'
...
vi.mock('@taiji/dsh-anonymous-user-id', () => ({
...
describe('@taiji/dsh-command-feedback registration', () => {
