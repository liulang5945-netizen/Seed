/** Package-owned scoped-dispatch invariants. @module @taiji/dsh-scope/invariant */

import type { Context } from '@taiji/cordis'
import type { InvariantInstaller } from '@taiji/dsh-invariants'
import { carrierKeyOf, isScopeCarrier } from '@taiji/dsh-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@taiji/dsh-scope'
