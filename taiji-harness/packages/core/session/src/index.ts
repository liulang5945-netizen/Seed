...
import { scopeOf, scopeTarget } from '@taiji/dsh-scope'
...
import type { TypertLookup } from '@taiji/dsh-typert-protocol'
...
export type { AssistantMessage, DeveloperMessage, SystemMessage, ToolResultMessage, UserMessage } from '@taiji/dsh-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@taiji/dsh-session#Session',
