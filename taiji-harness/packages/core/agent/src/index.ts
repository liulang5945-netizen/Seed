...
import { Context, FiberState, getTraceable, Service, symbols } from '@taiji/cordis'
...
import type { SessionEvent, SessionId, SessionLogOffset } from '@taiji/dsh-session'
 ...
 * (`@taiji/dsh-agent-loop`), registered via {@link setFactory}.
 *
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('agent', {
        parameter: 'agent',
        wire: 'agentId',
        hostTypeSymbol: '@taiji/dsh-agent#Agent',
