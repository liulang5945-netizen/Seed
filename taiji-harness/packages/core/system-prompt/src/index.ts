 ...
 *
 * @module @taiji/dsh-system-prompt
 */

import { Context, Service } from '@taiji/cordis'
import z from '@taiji/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@taiji/dsh-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@taiji/dsh-scope'
import type { ContextSnapshotSection, ToolSchema } from '@taiji/dsh-llm'
...
declare module '@taiji/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@taiji/dsh-scope`): scoped listeners
