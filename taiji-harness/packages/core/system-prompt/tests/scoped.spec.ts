...
import { createScope, scopeOf } from '@taiji/dsh-scope'
import type { Scope, ScopeKey } from '@taiji/dsh-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@taiji/dsh-system-prompt'
import type { Config, PromptAssembly } from '@taiji/dsh-system-prompt'
