...
import type { AttachmentIdType, FileAttachmentRef, ImageAttachmentRef } from '@taiji/dsh-attachment'
...
import { SessionLogOffset, SessionSeq, type SessionId } from '@taiji/dsh-session/types'
