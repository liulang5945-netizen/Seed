 ...
 * to `@taiji/dsh-jobs`; this seam exposes only process handles. The
...
import type { CollectedOutput, DshEnvironment, SubprocessOutputReader } from '@taiji/dsh-subprocess'

export { DSH_ENV_PREFIX } from '@taiji/dsh-subprocess'
export type { CollectedOutput, DshEnvironment, DshEnvironmentKey, SubprocessOutputRead, SubprocessOutputReader } from '@taiji/dsh-subprocess'
