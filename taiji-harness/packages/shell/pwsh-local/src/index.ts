...
import type { CollectedOutput, ShellExecRequest, ShellExecSpec, ShellExecution, ShellProcess, ShellProcessRead, ShellRunResult } from '@taiji/dsh-shell'
import type { SubprocessCollect, SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@taiji/dsh-subprocess'
import { clampTimeout, deadline, MAX_TIMER_DELAY_MS, timeoutOf } from '@taiji/dsh-timeout'
/* jscpd:ignore-end */
...
export class PwshLocalExecutor extends ShellExecutor {
   ...
   * pwsh-confining consumer is `@taiji/dsh-pwsh-sandbox`.
