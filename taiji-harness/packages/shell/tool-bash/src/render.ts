 ...
 *
 * @module @taiji/dsh-tool-bash/render
 */

import type { ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@taiji/dsh-shell'
 ...
 * rendering story, owned by `@taiji/dsh-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@taiji/dsh-shell'
