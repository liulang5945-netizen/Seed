 ...
 * `@taiji/dsh-pwsh-local`) backs `ctx.shell`; the tool contract is
 ...
 * exit-status parse from `@taiji/dsh-shell`.
 *
 * @module @taiji/dsh-tool-pwsh
 */
...
import { parseExitStatus } from '@taiji/dsh-shell'
