/**
 * Unit + real-load-path coverage for @taiji/dsh-tool-call-timeout-policy. The
...
import { ToolCallId, HarnessError } from '@taiji/dsh-llm'
import SystemPrompt from '@taiji/dsh-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@taiji/dsh-tools'
import * as timeoutPolicy from '@taiji/dsh-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@taiji/dsh-tool-call-timeout-policy'
