...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@taiji/dsh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@taiji/dsh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@taiji/dsh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@taiji/dsh-skill-filesystem"}\n',
