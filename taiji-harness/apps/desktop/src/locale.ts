...
export const en = {
  ...
  aboutMenu: 'About Taiji Harness',
  hideApplication: 'Hide Taiji Harness',
  hideOtherApplications: 'Hide Others',
  showAllApplications: 'Show All',
  quitApplication: 'Quit Taiji Harness',
  edit: 'Edit',
  ...
  startupFailed: 'Taiji Harness is unavailable',
  fatalSummary: 'The application could not start or stopped unexpectedly.',
  startupAddressInUse: 'Another Taiji Harness instance (such as dsh web or the desktop app) is running. They cannot start at the same time. Quit the other running Taiji Harness instance, then restart.',
  ...
  welcomeTitle: 'Taiji Harness',
  welcomeBrand: 'Taiji Harness',
  welcomeTaglineBefore: 'Welcome to ',
  welcomeTaglineBrand: 'Taiji Harness',
  welcomeTaglineAfter: '',
  ...
  updateDownloadedTitle: 'Taiji Harness v{version} downloaded',
...
export const zh = {
  application: '应用',
  aboutMenu: '关于 Taiji Harness',
  hideApplication: '隐藏 Taiji Harness',
  hideOtherApplications: '隐藏其他',
  showAllApplications: '显示全部',
  quitApplication: '退出 Taiji Harness',
  edit: '编辑',
  menuBar: '应用菜单',
  delete: '删除',
  undo: '撤销',
  ...
  paste: '粘贴',
  selectAll: '全选',
  startupFailed: 'Taiji Harness 无法使用',
  fatalSummary: '应用无法启动或已意外停止。',
  startupAddressInUse: '有其他正在运行的 Taiji Harness（如其他 dsh web、桌面端），无法同时启动，请退出其他正在运行的 Taiji Harness 后重启。',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'Taiji Harness v{version} 下载完成',
