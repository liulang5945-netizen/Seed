...
import { renderAgentInstructions } from '@taiji/dsh-agent-instructions'
import { resolveConfig, workspaceBaselineIdentity } from '@taiji/dsh-agent-instructions/src/config.ts'
