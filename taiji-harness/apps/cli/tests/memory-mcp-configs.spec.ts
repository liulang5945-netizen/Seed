...
import { boot, loadOverlayPatches } from '@taiji/dsh-app-boot'
import SystemPrompt from '@taiji/dsh-system-prompt'
import ToolRuntime from '@taiji/dsh-tools'
import * as McpClient from '@taiji/dsh-mcp-client/src/index.ts'
...
describe('third-party memory MCP example overlays', () => {
  it.each(examples)('parses $file with the documented generic plugin fields', (contract) => {
    ...
    expect(row.name).toBe('@taiji/dsh-mcp-client')
