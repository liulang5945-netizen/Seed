...
import type { CordisCatalogModel, ServiceMethodEntry } from '@taiji/dsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    ...
    .replaceAll('@taiji/dsh-tool-cordis/api-catalog', '@taiji/dsh-cordis-client-runner/client/api-catalog')
