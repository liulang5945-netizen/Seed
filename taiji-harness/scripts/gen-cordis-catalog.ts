...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@taiji/dsh-typert-generator'
import type { CordisCatalogPolicy } from '@taiji/dsh-typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@taiji/cordis'`
 ...
 * scan reads EVERY `declare module '@taiji/cordis'` Events merge under
