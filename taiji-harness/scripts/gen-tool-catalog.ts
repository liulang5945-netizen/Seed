...
import SqliteSessionQueryEngine from '@taiji/dsh-session-query-sqlite'
import GoalService from '@taiji/dsh-goal'
import SystemPrompt from '@taiji/dsh-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@taiji/dsh-tools'
import LocalBashExecutor from '@taiji/dsh-bash-local'
import * as BashEnvPlugin from '@taiji/dsh-shell-env'
import { PwshLocalExecutor } from '@taiji/dsh-pwsh-local'
import LocalSubprocessRuntime from '@taiji/dsh-subprocess-local'
import LocalFileSystem from '@taiji/dsh-fs-local'
import { AttachmentStore } from '@taiji/dsh-attachment'
import type { ImageAttachmentLimits, ImageAttachmentRef, SaveImageAttachment, StoredImageAttachment } from '@taiji/dsh-attachment'
import UserQuestionService from '@taiji/dsh-user-questions'
import PlanModeController from '@taiji/dsh-plan-mode'
import WebRuntime from '@taiji/dsh-web'
import * as WebSearchExa from '@taiji/dsh-web-search-exa'
import * as WebFetchLocal from '@taiji/dsh-web-fetch-http'
import SubagentRuntime from '@taiji/dsh-subagent'
import type { SubagentProvider } from '@taiji/dsh-subagent'
import * as ToolSubagentControl from '@taiji/dsh-tool-subagent-control'
import * as ToolSubagentListAgents from '@taiji/dsh-tool-subagent-control/list-agents'
...
import * as ToolAskUser from '@taiji/dsh-tool-ask-user'
import * as ToolBash from '@taiji/dsh-tool-bash'
...
import CordisHostRunner from '@taiji/dsh-cordis-host-runner'
import * as ToolCordis from '@taiji/dsh-tool-cordis'
import * as ToolPresent from '@taiji/dsh-tool-present'
import * as ToolFs from '@taiji/dsh-tool-fs'
import * as ToolFsSearch from '@taiji/dsh-tool-fs-search'
import * as ToolStrReplaceEditor from '@taiji/dsh-tool-str-replace-editor'
...
import * as ToolSchedule from '@taiji/dsh-schedule'
import Lsp from '@taiji/dsh-lsp'
import * as ToolLsp from '@taiji/dsh-tool-lsp'
import * as ToolSkill from '@taiji/dsh-tool-skill'
import * as ToolSessionQuery from '@taiji/dsh-tool-session-query'
import * as ToolJobs from '@taiji/dsh-tool-jobs'
import BrowserUseRegistry from '@taiji/dsh-browser-use'
import * as StagehandBrowserTools from '@taiji/dsh-experimental-browser-use-stagehand-native'
import type TeamService from '@taiji/dsh-experimental-agent-team'
import * as ToolTeam from '@taiji/dsh-experimental-tool-agent-team'
import * as ToolTodo from '@taiji/dsh-tool-todo'
import type PluginManager from '@taiji/dsh-plugin-manager'
import * as PluginManagerTools from '@taiji/dsh-plugin-manager/tools'
...
import * as ToolWeb from '@taiji/dsh-tool-web'
import WorkflowEngine from '@taiji/dsh-workflow'
import type { WorkflowRun, WorkflowStartRequest } from '@taiji/dsh-workflow'
import * as ToolRalph from '@taiji/dsh-tool-ralph'
import * as ToolWorkflow from '@taiji/dsh-tool-workflow'
import * as ToolWorkspaceDependencies from '@taiji/dsh-tool-workspace-dependencies'
...
const TOOL_PACKAGES: ToolPackage[] = [
  ...
  {
    pkg: '@taiji/dsh-experimental-browser-use-stagehand-native',
  ...
  },
  {
    ...
    note:
      'The bash tool is the model-facing consumer of the bash executor seam. With a job registry composed every call registers with the generic `ctx.jobs` runtime as it starts, collected/stopped through the `job_*` tools from `@taiji/dsh-tool-jobs`; without one, or with `enableRunInBackground: false`, the tool registers a foreground-only schema without the `run_in_background` parameter.',
  },
  {
    pkg: '@taiji/dsh-tool-present',
    dir: 'tool-present',
  ...
  },
  {
    ...
    note:
      'The pwsh tool is the PowerShell-dialect consumer of the bash executor seam for Windows compositions (a PowerShell executor such as `@taiji/dsh-pwsh-local` backs `ctx.shell`); it mirrors the bash tool call-for-call minus sandbox controls — `run_in_background` runs register with the generic `ctx.jobs` runtime and are collected/stopped through the `job_*` tools, and the managed `DSH_*` environment comes from `@taiji/dsh-shell-env`. Each call runs in a fresh process (no persistent PTY session), with native `C:\\...` paths and `$env:NAME` variables.',
  },
  {
    pkg: '@taiji/dsh-tool-cordis',
    dir: 'tool-cordis',
  ...
  {
    pkg: '@taiji/dsh-tool-bash-persistent',
  ...
  {
    pkg: '@taiji/dsh-tool-pwsh-persistent',
  ...
  {
    pkg: '@taiji/dsh-tool-str-replace-editor',
  ...
  },
  {
    ...
    note:
      'The read-before-write/edit policy is added by `@taiji/dsh-fs-observation-policy` (an `fs/*` event-gate plugin, no schema change); a deployment that loads these tools is expected to also load it. The image tool is not registered without `ctx.attachments`; its schema is route-independent, and execution refuses unless the exact routed model declares image input.',
  },
  {
    pkg: '@taiji/dsh-tool-fs-search',
    dir: 'tool-fs-search',
  ...
  },
  {
    ...
    note:
      'The lsp tool keeps provider selection and language-server subprocesses behind ctx.lsp, so its model-visible schema stays stable across providers. Requires a registered provider (e.g. `@taiji/dsh-lsp-stdio`) at runtime; without one, a query returns the structured `LSP_UNAVAILABLE` error rather than changing the schema.',
  },
  {
    pkg: '@taiji/dsh-tool-ralph',
    dir: 'tool-ralph',
  ...
  {
    pkg: '@taiji/dsh-tool-session-query',
  ...
  {
    pkg: '@taiji/dsh-tool-subagent-control',
  ...
  {
    pkg: '@taiji/dsh-experimental-tool-agent-team',
    dir: 'tool-agent-team',
  ...
  {
    pkg: '@taiji/dsh-tool-workspace-dependencies',
