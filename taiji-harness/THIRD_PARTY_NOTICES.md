...
| --- | --- | --- | --- |
| `@taiji/cosmokit` | `cosmokit` | [vendor/cosmokit](vendor/cosmokit/) | MIT |
| `@taiji/schemastery` | `schemastery` | [vendor/schemastery](vendor/schemastery/) | MIT |
| `@taiji/cordis` | `cordis` | [vendor/cordis](vendor/cordis/) | MIT |
| `@taiji/cordis-plugin-loader` | `@cordisjs/plugin-loader` | [vendor/loader](vendor/loader/) | MIT |
| `@taiji/cordis-plugin-include` | `@cordisjs/plugin-include` | [vendor/include](vendor/include/) | MIT |
| `@taiji/cordis-plugin-group` | `@cordisjs/plugin-group` | [vendor/group](vendor/group/) | MIT |
| `@taiji/cordis-plugin-timer` | `@cordisjs/plugin-timer` | [vendor/timer](vendor/timer/) | MIT |
| `@taiji/cordis-plugin-hmr` | `@cordisjs/plugin-hmr` | [vendor/hmr](vendor/hmr/) | MIT |
| `@taiji/cordis-plugin-logger-console` | `@cordisjs/plugin-logger-console` | [vendor/logger-console](vendor/logger-console/) | MIT |
