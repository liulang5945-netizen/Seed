...
async function run(root: string): Promise<ProfileReport> {
  ...
  await writeFile(patch, [
    ...
    '- insert:',
    '    - id: fs-local', "      name: '@taiji/dsh-fs-local'",
    '    - id: str-replace-editor', "      name: '@taiji/dsh-tool-str-replace-editor'",
...
assertBuiltBenchmarkRuntime(import.meta.url, { '@taiji/dsh-sdk-client': import.meta.resolve('@taiji/dsh-sdk-client') })
