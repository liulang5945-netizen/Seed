...
import { createUserMessage, LlmAdapter } from '@taiji/dsh-llm'
...
assertBuiltBenchmarkRuntime(import.meta.url, Object.fromEntries([
  '@taiji/dsh-agent-loop', '@taiji/dsh-session', '@taiji/dsh-llm',
  '@taiji/dsh-tools', '@taiji/dsh-session-persistence-jsonl',
