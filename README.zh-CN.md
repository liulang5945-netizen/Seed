...
- 当前主线：继续执行已获准的 H3.7 seed `20260918/20260919` matched dev（control/treatment，各10 epoch、每臂最多120 episodes、final延迟），分别执行冻结的只读 bridge/slot-credit ablation，最后运行三 seed aggregate gate；H3.6-B final 保持未读，H3.7 final、默认采用与 Mini 继续后置。
