"""Platform-owned application state.

This module contains lifecycle flags, model handles and coordination locks
shared by Seed services. It deliberately does not import Neuroplex or any
Legacy model implementation. Optional Legacy integrations may inject objects
such as a RAG knowledge base after the platform state has been created.
...
# Global platform state instance. Legacy integrations may populate optional
# fields such as ``rag_kb`` during their own startup hook.
app_state = AppState()
