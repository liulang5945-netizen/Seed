...
Development guide (2026-09-18): M5/R2 remains the research focus; D1–D5 evidence is tracked in the [results ledger](plans/reference/PROJECT_RESULTS_AND_CONCLUSIONS_20260917.md). The [current execution plan](plans/active/roadmap/03_CURRENT_EXECUTION.md) is the sole source for the active package and next decision. The [phase map §6.3–6.5](plans/active/roadmap/01_SCOPE_AND_PHASES.md) now defines evidence reuse, capability transitions and deliverables; [VISION §17.5–17.7](plans/reference/VISION_FUTURE_TECHNOLOGY.md) specifies curriculum coverage and model evolution; the [integration handoff §5.2](plans/active/roadmap/07_MINI_MODEL_DELIVERY.md) connects research candidates to one identifiable bundle. Bounded local experiments remain allowed within their authorization. These plans do not themselves authorize training, grant L2/L3 promotion or trigger Mini delivery.
